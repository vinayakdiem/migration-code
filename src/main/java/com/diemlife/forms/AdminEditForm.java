...
public class AdminEditForm {
	...
	@Constraints.Required(message = "Please enter the users goals")
	public String goals;
	@Constraints.Required(message = "Please enter the users zip code")
	public String zip;
	@Constraints.Required(message = "Please enter a username")
