...
package com.diemlife.com.amazonaws.geo;
...
import com.diemlife.com.amazonaws.AmazonClientException;
import com.diemlife.com.amazonaws.geo.dynamodb.internal.DynamoDBManager;
import com.diemlife.com.amazonaws.geo.dynamodb.internal.DynamoDBUtil;
...
import com.diemlife.com.amazonaws.geo.model.GeoQueryRequest;
import com.diemlife.com.amazonaws.geo.model.GeoQueryResult;
...
import com.diemlife.com.amazonaws.geo.model.QueryRectangleRequest;
import com.diemlife.com.amazonaws.geo.model.QueryRectangleResult;
...
import com.diemlife.com.amazonaws.geo.s2.internal.S2Util;
...
import com.diemlife.com.google.common.geometry.S2CellId;
import com.diemlife.com.google.common.geometry.S2CellUnion;
import com.diemlife.com.google.common.geometry.S2LatLng;
import com.diemlife.com.google.common.geometry.S2LatLngRect;
		...
		for (Map<String, AttributeValue> item : list) {
			...
			if (latLngRect != null && latLngRect.contains(latLng)) {
				result.add(item);
					...
					&& centerLatLng.getDistance(latLng, 6367000.0) <= radiusInMeter) {
				result.add(item);
			}
		}
