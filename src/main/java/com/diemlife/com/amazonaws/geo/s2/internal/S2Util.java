...
package com.diemlife.com.amazonaws.geo.s2.internal;
...
public class S2Util {
	...
	public static S2LatLngRect getBoundingLatLngRect(GeoQueryRequest geoQueryRequest) {
		if (geoQueryRequest instanceof QueryRectangleRequest) {
			...
			double latForRadius = radiusInMeter / centerLatLng.getDistance(latReferenceLatLng, 6367000.0);
			//double lngForRadius = radiusInMeter / centerLatLng.getEarthDistance(lngReferenceLatLng);
			double lngForRadius = radiusInMeter / centerLatLng.getDistance(lngReferenceLatLng, 6367000.0);
